function [probability_of_success, probability_of_draw] = Markov_chain(number_of_nodes, initial_nodes_in_value1)
...
for value_level_1_ROW = 0:number_of_nodes
    str = sprintf('In Markov: Value %d out of %d values', value_level_1_ROW, number_of_nodes);
    disp(str);
